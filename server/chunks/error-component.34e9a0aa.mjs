...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.e15694c7.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.a85c6e73.mjs'));
...
//# sourceMappingURL=error-component.34e9a0aa.mjs.map
